/**
 * Convenience screen for debugging speech recognition.
 * 
 * Adapted from the PocketSphinx for Android Demo
 * 
...
import edu.voicelabs.vst.DebugScreenActivity;
...
public class DebugScreenActivity extends Activity implements OnTouchListener, RecognitionListener {
	static {
	...
	public boolean onTouch(View v, MotionEvent event) {
		...
		case MotionEvent.ACTION_UP:
			...
			if (this.listening) {
				...
				this.rec_dialog = ProgressDialog.show(DebugScreenActivity.this, "", "Recognizing speech...", true);
	...
	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.debug_speech);
		
		startDebugSpeech();
	}
	
	public void startDebugSpeech() {
//		this.rec = new RecognizerTask(getApplicationContext());
	...
	public void onPartialResults(Bundle b) {
		final DebugScreenActivity that = this;
